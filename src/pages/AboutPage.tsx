  ...
  return (
    <>
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-text-primary mb-6">
              About <span className="text-primary-600">Shubh Milan</span>
            </h1>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-primary-100 to-primary-50 rounded-2xl p-8 md:p-12 border border-primary-200">
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-full p-2 mr-4">
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-primary-800 mb-1">Authentic Connections</h3>
                      <p className="text-text-secondary text-sm">Building genuine relationships based on trust</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-full p-2 mr-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary-800 mb-1">Cultural Values</h3>
                      <p className="text-text-secondary text-sm">Respecting traditions while embracing modernity</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-full p-2 mr-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary-800 mb-1">User Safety</h3>
                      <p className="text-text-secondary text-sm">Prioritizing security and privacy at every step</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-primary-50 via-white to-primary-50">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-primary-700 mb-12">Our Core Values</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border border-primary-100">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-3">Trust</h3>
                <p className="text-text-secondary">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border border-primary-100">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-3">Privacy</h3>
                <p className="text-text-secondary">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border border-primary-100">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-3">Authenticity</h3>
                <p className="text-text-secondary">
      ...
      <section className="py-16 md:py-20 bg-white">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-primary-700 mb-6">Our Story</h2>
