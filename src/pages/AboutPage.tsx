              ...
              <div className="bg-white rounded-2xl p-8 md:p-12 border border-primary">
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary mb-1">Authentic Connections</h3>
                      <p className="text-primary text-sm">Building genuine relationships based on trust</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-primary rounded-full p-2 mr-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary mb-1">Cultural Values</h3>
                      <p className="text-primary text-sm">Respecting traditions while embracing modernity</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-primary rounded-full p-2 mr-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-primary mb-1">User Safety</h3>
                      <p className="text-primary text-sm">Prioritizing security and privacy at every step</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border border-primary">
                ...
                <h3 className="text-xl font-semibold text-primary mb-3">Trust</h3>
                <p className="text-primary">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all border border-primary">
                ...
                <h3 className="text-xl font-semibold text-primary mb-3">Privacy</h3>
                <p className="text-primary">
