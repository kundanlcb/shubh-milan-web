...
export const FeaturesPage = () => {
  return (
    <div className="py-12 md:py-20 bg-gradient-to-br from-primary-50 via-white to-primary-50">
      <Container>
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-primary-700 mb-6">Features</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">Advanced Search Filters</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">Video Calls</h3>
            <p className="text-text-secondary">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">Secure Messaging</h3>
            <p className="text-text-secondary">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">Profile Verification</h3>
            <p className="text-text-secondary">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">Interest Matching</h3>
            <p className="text-text-secondary">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all border border-primary-100 hover:border-primary-300">
            ...
            <h3 className="text-2xl font-semibold text-primary-800 mb-4">24/7 Support</h3>
            <p className="text-text-secondary">
